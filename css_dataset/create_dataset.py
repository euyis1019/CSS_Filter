...
from fairscale.utils.object import tensor_to_pyobject

from css_dataset.loadutils import auto_init, get_dataset_config
from css_dataset.dataset import dataset_entrypoints, is_dataset_registered, filter_images, save_list_from_filter
...
if __name__ == "__main__":
    ...
    def label_to_image(label,i1):
        ...
        image.save(f"label_{i1}.png")


    for i,batch in enumerate(dataset):
        print(batch["text_prompt"])
        print(batch["label_prompt"])
